<div class="container mb-5">
    <h2 class="m-3 mb-5 h2">Sélection de thèmes</h2>
    <ul class="nav nav-pills m-3 mb-5 border-bottom text-center center" id="pills-tab" role="tablist">
        @foreach($tags as $tag)
        <li class="nav-item center" role="presentation">
