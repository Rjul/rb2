<section class="wavy-box text-white relative ">
    ...
    <div style="background-color: #001C41">
        <div class="container" id="homepage-programme-collapse m-5 p-5">
            ...
            <div class="row">
                <div class="col-12 col-xl-6">
                    ...
                    @foreach($emisions as $emision)
                        <button class="btn btn-primary row bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseCard{{ $loop->index }}" aria-expanded="{{ $loop->first ? 'true' : 'false' }}" aria-controls="#multiCollapseCard{{ $loop->index }}">
